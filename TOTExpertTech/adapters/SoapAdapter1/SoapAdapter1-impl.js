...
function TempConvert_CelsiusToFahrenheit(params, headers){
	var soapEnvNS = '';
    ...
    var mappings = {
		roots: {
			'CelsiusToFahrenheit': { nsPrefix: 'tns', type: 'tns:CelsiusToFahrenheit' }				
		},
		
		types: {
			'tns:CelsiusToFahrenheit': {
				children: [
					{'Celsius': { nsPrefix: 'tns' }}	
				]
			}
		}
	};
    var namespaces = 'xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:tns="http://www.w3schools.com/webservices/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://www.w3schools.com/webservices/CelsiusToFahrenheit';
    return invokeWebService(request, headers, soapAction);
}


function TempConvert_FahrenheitToCelsius(params, headers){
	var soapEnvNS = '';
    // The value of 'soapEnvNS' was set based on the version of the SOAP to be used (i.e. 1.1 or 1.2).
    soapEnvNS = 'http://schemas.xmlsoap.org/soap/envelope/';
    ...
    var mappings = {
		roots: {
			'FahrenheitToCelsius': { nsPrefix: 'tns', type: 'tns:FahrenheitToCelsius' }				
		},
		
		types: {
			'tns:FahrenheitToCelsius': {
				children: [
					{'Fahrenheit': { nsPrefix: 'tns' }}	
				]
			}
		}
	};
    var namespaces = 'xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:tns="http://www.w3schools.com/webservices/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://www.w3schools.com/webservices/FahrenheitToCelsius';
    return invokeWebService(request, headers, soapAction);
}
