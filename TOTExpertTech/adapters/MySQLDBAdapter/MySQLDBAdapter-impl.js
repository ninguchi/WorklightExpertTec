...
var insertWorkOrderNewWorkUnitStatement = WL.Server.createSQLStatement("insert into WORK_ORDER_STATUS (WOO_WORKUNIT, WOO_SEQUENCE, WOO_WOS_ID, WOO_PRODUCT_TYPE1, WOO_PRODUCT_TYPE2, WOO_ORDER_NO, WOO_GIS, WOO_LATITUDE, WOO_LONGITUDE) values (?,?,?,?,?,?,?,?,?) ");
...
var insertCustFeedbackStatement = WL.Server.createSQLStatement("insert into CUS_FEEDBACK (CUF_WORKUNIT, CUF_WOO_ID, CUF_TIMELESS, CUF_HELPFUL, CUF_QUANLITY, CUF_COMMU, CUF_OVERALL, CUF_CREATED_DATE) values (?,?,?,?,?,?,?,?) ");
